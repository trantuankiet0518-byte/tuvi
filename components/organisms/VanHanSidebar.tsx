...
export default function VanHanSidebar() {
  return (
    <div className="md:col-span-3 space-y-8">
      {/* Chủ thể */}
      <div className="bg-surface-container p-8 rounded-[2rem] shadow-lg shadow-background/50">
      ...
      {/* Lưu tinh điểm nhấn */}
      <div className="bg-surface-container/30 backdrop-blur-sm p-8 rounded-[2rem] shadow-sm">
