...
export default async function AuthLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <main className="relative min-h-dvh overflow-hidden bg-[#0b0b0c] text-foreground selection:bg-primary selection:text-on-primary">
      ...
      <div className="relative z-10 mx-auto flex min-h-dvh w-full max-w-[620px] flex-col px-4 py-5 sm:px-6">
